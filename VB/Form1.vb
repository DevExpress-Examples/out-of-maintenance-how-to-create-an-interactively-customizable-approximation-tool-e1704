...
Namespace ChartApproximation
	Partial Public Class Form1
		...
		Private Sub InitializeSourceSeires()
			...
			scatteredSeries.PointOptions.ValueNumericOptions.Format = NumericFormat.FixedPoint
			scatteredSeries.PointOptions.ValueNumericOptions.Precision = 2
		...
		Private Sub chartControl1_ObjectHotTracked(ByVal sender As Object, ByVal e As HotTrackEventArgs) Handles chartControl1.ObjectHotTracked
			...
			If editedSeriesPoint IsNot Nothing OrElse (e.HitInfo.InSeries AndAlso (CType(e.HitInfo.Series, Series)).Name = "Scattered") Then
